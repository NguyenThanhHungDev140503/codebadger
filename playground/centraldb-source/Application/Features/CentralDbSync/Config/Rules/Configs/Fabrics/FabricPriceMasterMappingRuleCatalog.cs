...
public sealed class FabricPriceMasterMappingRuleCatalog : ITableMappingRuleCatalog
{
    public IReadOnlyList<TableMappingRule> GetRules() =>
    [
        Create(
            ruleName: "ERP.Configs.Fabrics.Suppliers.Details",
            sourceTable: "ERP.Configs.Fabrics.Suppliers.Details",
            sourcePrimaryKey: "FabricSupplierDetailId",
            targetTable: "fabric_price_master",
            targetPrimaryKey: "fabric_price_master_id",
            filterCompany: true,
            columns:
            [
                MapPk("fabric_price_master_id", "integer", "t0.FabricSupplierDetailId"),
