...
public sealed class FabricWeaveParametersMappingRuleCatalog : ITableMappingRuleCatalog
{
    public IReadOnlyList<TableMappingRule> GetRules() =>
    [
        Create(
            ruleName: "ERP.Configs.Fabrics.WeaveParameters",
            sourceTable: "ERP.Configs.Fabrics.WeaveParameters",
            sourcePrimaryKey: "WeaveParameterId",
            targetTable: "fabric_weave_parameters",
            targetPrimaryKey: "fabric_weave_parameters_id",
            filterCompany: true,
            columns:
            [
                MapPk("fabric_weave_parameters_id", "integer", "t0.WeaveParameterId"),
